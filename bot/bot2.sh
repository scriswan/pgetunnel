...
function checking_sc() {
    ...
    IZIN=$(curl -sS https://raw.githubusercontent.com/scriswan/pgetunnel/main/register | awk '{print $4}')
...
cd /media/
rm -rf cybervpn
wget https://raw.githubusercontent.com/scriswan/pgetunnel/main/botol/cybervpn.zip
unzip cybervpn.zip
cd cybervpn
rm var.txt
rm database.db
...
rm bot.*
cd /usr/bin
wget https://raw.githubusercontent.com/scriswan/pgetunnel/main/botol/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
